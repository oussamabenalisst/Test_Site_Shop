...
<body>
    <div class="ex-basic-1 pt-3 pb-5">
        <div class="container">
            <form method="post" action="./ajoutTyprod.php" target="arr">
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">name TyProde</label>
            ...
            <table class="table table-hover">
                ...
                while ($row = mysqli_fetch_array($r)) {
                    ...
                    <tr>
                        ...
                        <td><?php echo "<a href='./sutyP.php?th=" . $row[0] . "' target='arr'>supp</a> " ?></td>
                    </tr>
                    <?php
                }
                ?>
