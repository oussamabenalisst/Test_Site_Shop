    ...
    <div class="ex-basic-1 pt-3 pb-5">
        <div class="container">
            <table class="table table-dark">
                    ...
                    <td colspan="3">
                        <form name="f" method="post" action="./detS.php" onsubmit="return verific()">
                            <div class="input-group">
                                ...
                                <input type="submit" class="btn btn-danger" style="background-color: #ff5262"
                                    value=" 🔍 " />
                            </div>
                        </form>
                    </td>
                ...
                <?php
                $p = "SELECT pr.idP, pr.nomP,pr.imgP,pr.diP,pr.prix FROM `pan` p , prod pr WHERE  pr.idP = p.idp and p.ip = '$loc_o->query' ";
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p>
                                ...
                                <a href="./suppPAN.php?id=<?php echo $row[0] ?>&ip=<?php echo $loc_o->query ?>"
                                    class="link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover"
                                    target="err"><i class="bi bi-bag-x"></i> Delete</a>
                            </p>
                        </td>
                    </tr>
                    <?php
